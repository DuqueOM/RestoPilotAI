...
class GeminiModel(str, Enum):
    """Available Gemini 3 models for the hackathon.

    Official Gemini 3 models as per hackathon requirements:
    https://gemini3.devpost.com/
    """

    FLASH = "gemini-3-flash-preview"  # Fast, primary for MenuPilot
    PRO = "gemini-3-pro-preview"  # Best reasoning for complex analysis
    PRO_IMAGE = "gemini-3-pro-image-preview"  # Image generation (not used)
...
class RateLimiter:
    ...
    def __init__(
        self, requests_per_minute: int = 60, tokens_per_minute: int = 1_000_000
    ):
