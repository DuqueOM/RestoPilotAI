...
class Competitor(Base):
    ...
    # Relationships
    menu_extractions = relationship("CompetitorMenuExtraction", back_populates="competitor")
...
class CompetitorMenuExtraction(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    competitor_id: Mapped[int] = mapped_column(Integer, ForeignKey("competitors.id"), index=True)
...
class CompetitorAnalysis(Base):
    ...
    competitive_intensity: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    
    # Price analysis
    price_positioning_analysis: Mapped[Optional[str]] = mapped_column(JSON, nullable=True)
    ...
    # Recommendations
    strategic_recommendations: Mapped[Optional[str]] = mapped_column(JSON, nullable=True)
...
class PriceComparison(Base):
    ...
    competitor_item_name: Mapped[Optional[str]] = mapped_column(String(200), nullable=True)
    ...
    price_difference_percent: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
